...
@section('content')
    <div class="grid grid-cols-1 lg:gap-16 md:gap-10">
        <div class="bg-white shadow-[0px_6px_16px_rgba(0,0,0,0.05)] rounded-xl">
            ...
            <form id="categoryForm" action="{{ route('admin.product.category.update', $category->id) }}" method="POST"
                ...
                <div class="p-5 grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="description" id="description" rows="4" maxlength="200"
                            class="w-full border rounded-lg px-3 py-2 focus:ring focus:ring-blue-200" placeholder="Enter category description">{{ $category->description }}</textarea>
                    ...
                    <div>
                        ...
                        <input type="text" name="commission" maxlength="50" id="commission" value="{{ $category->commission }}"
                            class="w-full border rounded-lg px-3 py-2 focus:ring focus:ring-blue-200"
                    ...
                    <div>
                        ...
                        <div class="mt-3">
                            <img id="previewImage"
                                src="{{ $category->image ? asset('storage/category/'.$category->image) : '' }}"
    ...
    <script>
        ...
        $('#categoryForm').submit(function(e) {
            ...
            $.ajax({
                url: "{{ route('admin.product.category.update', $category->id) }}",
                type: "POST",
                data: formData,
                processData: false,
                contentType: false,
                ...
                success: function(response) {
                    ...
                    if (response.success) {
                        ...
                        setTimeout(function() {
                            window.location.href = "{{ route('admin.product.category.list') }}";
                        }, 1000);
