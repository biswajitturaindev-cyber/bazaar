...
@section('content')
    <div class="grid grid-cols-1 lg:gap-16 md:gap-10">
        <div class="bg-white shadow-[0px_6px_16px_rgba(0,0,0,0.05)] rounded-xl">
            ...
            <div class="flex justify-between items-center p-5 border-b">
                <h2 class="text-lg font-semibold">Edit Product Sub Sub Category</h2>
            ...
            <div class="p-5">
                ...
                <form id="subCategoryItemForm" action="{{ route('admin.product.sub.category.item.update', $item->id) }}"
                        ...
                        <div>
                            ...
                            <select name="sub_category_id" id="sub_category_id"
                                ...
                                @foreach ($subcategories as $sub)
                                    <option value="{{ $sub->id }}"
                                        {{ $item->sub_category_id == $sub->id ? 'selected' : '' }}>
                                        {{ $sub->name }}
                                    </option>
                                @endforeach
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            // FORM SUBMIT AJAX
            $('#subCategoryItemForm').submit(function(e) {
                    ...
                    error: function(xhr) {
                        ...
                        if (xhr.status === 422) {
                            ...
                            $.each(errors, function(key, value) {
                                ...
                                if (key == 'category_id') {
                                    $('[name="category_id"]').after(
                                        '<p class="text-red-500 text-sm">' + value[
                                            0] + '</p>');
                                }
