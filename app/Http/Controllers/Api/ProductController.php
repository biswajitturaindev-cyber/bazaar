    ...
    public function update(Request $request, string $id)
    {
        ...
        try {
            ...
            foreach ($data['variants'] as $index => $variantData) {
                ...
                // ---------------------------------------------------------------
                // Images — existing images are KEPT (not deleted).
                // Update product_variant_id for existing images, then APPEND new uploads.
                // ---------------------------------------------------------------
                if ($request->hasFile("variants.$index.images")) {

                    // Update existing images' variant reference before appending new ones
