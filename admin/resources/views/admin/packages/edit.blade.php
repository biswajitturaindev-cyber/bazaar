    ...
    <div class="grid grid-cols-1 lg:gap-16 md:gap-10">
        <div class="bg-white shadow-[0px_6px_16px_rgba(0,0,0,0.05)] rounded-xl">
            ...
            <div class="flex justify-between items-center p-5 border-b">
                ...
                <a href="{{ route('packages.index') }}" class="bg-gray-600 text-white px-4 py-2 rounded-lg hover:bg-gray-700">
                    Back
                </a>
            </div>
                ...
                <div class="p-5 grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="number" name="duration" min="1"
                            ...
                            class="w-full border rounded-lg px-3 py-2 focus:ring focus:ring-blue-200" placeholder="e.g. 30">
                    ...
                    <div>
                        ...
                        <select name="duration_type"
                            ...
                            <option value="day"
                                {{ old('duration_type', $package->duration_type) == 'day' ? 'selected' : '' }}>
                                Day(s)
                            </option>

                            <option value="month"
                                {{ old('duration_type', $package->duration_type) == 'month' ? 'selected' : '' }}>
                                Month(s)
                            </option>

                            <option value="year"
                                {{ old('duration_type', $package->duration_type) == 'year' ? 'selected' : '' }}>
                                Year(s)
                            </option>
                        </select>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="description" rows="5" class="w-full border rounded-lg px-3 py-2 focus:ring focus:ring-blue-200"
